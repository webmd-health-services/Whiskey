...
function Remove-BBServerRepository
{
    ...
    .EXAMPLE
    Remove-BBServerRepository -Connection $conn -ProjectKey 'whs' -Name 'fubarsnafu'
    ...
    .EXAMPLE
    Remove-BBServerRepository -Connection $conn -ProjectKey 'whs' -Name 'fubarsnafu' -Force
    ...
    .EXAMPLE
    Get-BBServerRepository -Connection $conn -ProjectKey 'whs' -Name 'snafu' | Remove-BBServerRepository -Connection $conn
    ...
    .EXAMPLE
    'fubarsnafu' | Remove-BBServerRepository -Connection $conn -ProjectKey 'whs'
