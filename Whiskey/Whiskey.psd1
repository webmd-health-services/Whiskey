...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = @'
* Fixed: `GitHubRelease` task always uses an asset's file name as the asset's downloaded file name instead of the asset's `Name` property from the whiskey.yml file.
'@
