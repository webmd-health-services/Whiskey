...
@{
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = @'
* Fixed: The .NET Core releases index file Whiskey was checking stopped working. We now try a couple of different URIs for the releases index.
'@
