...
function Set-BBServerCommitBuildStatus
{
    ...
    .EXAMPLE
    Set-BBServerCommitBuildStatus -Connection $conn -Status Successful -CommitID 'e24e50bba38db28fb8cf433d00c0d3372f8405cf' -Key 'jenkins-Whiskey-140' -BuildUri 'https://jenkins.example.com/job/Whiskey/140/' -Name 'Whiskey' -Verbose
