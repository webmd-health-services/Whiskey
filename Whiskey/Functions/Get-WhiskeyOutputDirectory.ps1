...
function Get-WhiskeyOutputDirectory
{
    <#
    .SYNOPSIS
    ...
    .DESCRIPTION
    The `Get-WhiskeyOutputDirectory` gets the path to the directory where build output should go. Test results, binaries, packages, reports, etc. should all be put into this directory. You pass it a working directory, which is usually the path to the root of the repository of the curent build.
    ...
    .EXAMPLE
    Get-WhiskeyOutputDirectory -WorkingDirectory $env:WORKSPACE
