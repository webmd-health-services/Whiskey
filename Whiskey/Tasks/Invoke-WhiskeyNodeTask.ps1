...
function Invoke-WhiskeyNodeTask
{
    ...
    Write-Warning -Message ('The "Node" task is obsolete and will be removed in a future version of Whiskey. It''s functionality has been broken up into individual smaller tasks, "NpmInstall", "NpmRunScript", "NpmAudit", and "NodeLicenseChecker". Update the build configuration in "{0}" to use the new tasks.' -f $TaskContext.ConfigurationPath)
