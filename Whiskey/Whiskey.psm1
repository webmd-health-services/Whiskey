...
$script:errorActionPropertyName = '.error_action'
$script:exceptByPropertyName = '.except_by'
$script:exceptDuringPropertyName = '.except_during'
$script:exceptOnBranchPropertyName = '.except_on_branch'
$script:exceptOnPlatformPropertyName = '.except_on_platform'
$script:ifExistsPropertyName = '.if_exists'
$script:informationActionPropertyName = '.information_action'
$script:onlyByPropertyName = '.only_by'
$script:onlyDuringPropertyName = '.only_during'
$script:onlyOnBranchPropertyName = '.only_on_branch'
$script:onlyOnPlatformPropertyName = '.only_on_platform'
$script:outVariablePropertyName = '.out_variable'
$script:unlessExistsPropertyName = '.unless_exists'
$script:verbosePropertyName = '.verbose'
$script:warningActionPropertyName = '.warning_action'
$script:workingDirectoryPropertyName = '.working_directory'
